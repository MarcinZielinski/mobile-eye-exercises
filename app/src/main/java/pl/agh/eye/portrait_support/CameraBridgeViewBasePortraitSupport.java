...
public abstract class CameraBridgeViewBasePortraitSupport extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraBridgeViewBasePortraitSupport(Context context, int cameraId) {
        super(context);
    ...
    public CameraBridgeViewBasePortraitSupport(Context context, AttributeSet attrs) {
        super(context, attrs);
